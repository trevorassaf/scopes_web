...
$cosign_cfg['CosignRequireFactor'] = 'umich.edu';
...
$cosign_cfg['CosignSiteEntry'] = '../index.html';
...
$cosign_cfg['CosignCryptoLocalCert'] = '../ssl/pem/mvscorefacility-dev.pem';
...
$cosign_cfg['CosignCryptoCAFile'] = '../ssl/1aff46ac.0/inc-md-cert.pem';

// CA certificates directory (must be a correctly hashed certificate directory)
$cosign_cfg['CosignCryptoCAPath'] = '../ssl/1aff46ac.0';
...
$cosign_cfg['CosignTicketPrefix'] = 'tickets/';
