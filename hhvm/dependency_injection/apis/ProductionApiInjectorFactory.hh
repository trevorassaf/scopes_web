  ...
  public function get(): ApiInjector {
    if ($this->productionApiInjector === null) {
      ...
      $this->productionApiInjector = new ApiInjector(
        ...
        new UpdateConfirmedOrderApiRequestFactoryLazyLoader(),
        ...
        new GetStartupDataApiRequestFactoryLazyLoader(),
        new UpdateConfirmedOrderRequestApiToInternalConverterLazyLoader()
      ); 
    }
